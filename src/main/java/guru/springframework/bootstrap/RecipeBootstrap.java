...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        List<Recipe> recipes = new ArrayList(2); // Create a list for the 2 recipes
        ...
        /**
         *  Get Optionals for UnitsOfMeasure
         */
        ...
        guacRecipe.setDifficulty(Difficulty.EASY); // Use the Enum (Difficulty)
        ...
        /**
         * Add Url, servings, and source to the guacRecipe
         */
        guacRecipe.setUrl("http://www.simplyrecipes.com/recipes/perfect_guacamole/");
        guacRecipe.setServings(4);
        guacRecipe.setSource("Super reçettes de mémé");

        /**
         * Add the guacRecipe to recipes' list
         */
        ...
        /**
         * Save notes and recipe (needs to be done both ways!!!)
         */
